    ...
    en: {
                    ...
                    categories: {
                        ...
                        legal: {
                            ...
                            items: [
                                ...
                                { name: "BenefitsCheckUp", desc: "A free service of the National Council on Aging to find benefit programs.", link: "https://benefitscheckup.org/" },
        ...
        data: {
            ...
            crew: [
                ...
                { name: "Marisela Rondon", role: "Costume Designer", bio: `Venezuelan costume designer and wardrobe stylist based in Miami, with over 20 years of experience in film, television, commercials, and music videos. Bachelor's degree in Social Communication with specialization in Public Relations and Advertising from Universidad Católica Andrés Bello (UCAB).\n\nHer work includes the feature film SIMON THE FILM (2021) directed by Diego Vicentini, the miniseries LA FUERZA DE CREER "DULCE SAZÓN" Season 4 for Univision (2023) directed by Charlie Cartaya, and the short film NYCTO SERIES (2023) directed by Ángel Barroeta.\n\nRecognized for her cultural sensitivity and ability to build characters and emotions through wardrobe, her work combines narrative intuition with meticulous attention to detail. For The Last Station, she creates wardrobe that reflects the characters' emotional journey without competing with the narrative.`, img: "/Marisela Rondon.jpg" },
                { name: `José Ignacio Jiménez “Nacho”`, role: "Production Design & Props", bio: `Nacho Jiménez, from La Guapa Productions, was part of the art department of La Última Estación, contributing to production design and props with a strong narrative sensibility. His work played a key role in bringing Annie’s diary to life—an essential object that serves as an emotional and symbolic thread throughout the story.\n\nThrough production design, Nacho helped shape two distinct visual worlds: Jessica’s and Annie’s, each with its own identity and visual language. The train became Jessica’s inner space, a world that gradually transforms as her emotional journey unfolds.\n\nThe intentional use of color palettes guides the viewer through different timelines and emotional states, subtly marking transitions in mood and memory. Every object, texture, and visual choice adds coherence, depth, and atmosphere to the world of La Última Estación.`, img: "/Nacho.jpg" },
    ...
    es: {
                    ...
                    categories: {
                        support: {
                            ...
                            items: [
                                ...
                                { name: "Family Caregiver Alliance", desc: "", link: "https://www.caregiver.org/spanish/" },
                                { name: "Estrés del cuidador y prevención el enlace no esta actualizado", desc: "", link: "https://www.alz.org/es-mx/ayuda-y-apoyo/cuidado/salud-de-cuidadores/estres-de-cuidadores?utm_source=chatgpt.com" }
                            ]
                        },
                        legal: {
                        ...
                        community: {
                            ...
                            items: [
                                ...
                                { name: "Grupos de Apoyo Virtuales de AARP", desc: "Grupos de apoyo en línea para cuidadores hispanos que comparten experiencias similares.", link: "https://www.aarp.org/espanol/recursos-para-el-cuidado/211-ayuda/recursos-para-cuidadores-en-tu-estado/" },
                                { name: "Club de Cuidadores", desc: "", link: "https://www.clubdecuidadores.com/" },
                                { name: "Caregiver Resources Center- Grupo de Apoyo", desc: "", link: "https://es.caregiveroc.org/support-groups" }
                            ]
                        },
                        literature: {
        ...
        data: {
            ...
            crew: [
                ...
                { name: "Marisela Rondon", role: "Diseñadora de Vestuario", bio: `Diseñadora de vestuario y wardrobe stylist venezolana con sede en Miami, con más de 20 años de experiencia en cine, televisión, comerciales y videos musicales. Licenciada en Comunicación Social con especialización en Relaciones Públicas y Publicidad por la Universidad Católica Andrés Bello (UCAB).\n\nSu trabajo incluye el largometraje SIMON THE FILM (2021) dirigido por Diego Vicentini, la miniserie LA FUERZA DE CREER "DULCE SAZÓN" Temporada 4 para Univision (2023) dirigida por Charlie Cartaya, y el cortometraje NYCTO SERIES (2023) dirigido por Ángel Barroeta.\n\nReconocida por su sensibilidad cultural y habilidad para construir personajes y emociones a través del vestuario, su trabajo combina intuición narrativa con atención meticulosa al detalle. Para La Última Estación, crea un vestuario que refleja el viaje emocional de los personajes sin competir con la narrativa.`, img: "/Marisela Rondon.jpg" },
                { name: `José Ignacio Jiménez “Nacho” `, role: "Production Design & Props", bio: `Nacho Jiménez, de La Guapa Productions, formó parte del departamento de arte de La Última Estación, colaborando en el diseño de producción y utilería con una sensibilidad artística clave para la narrativa visual del film. Su trabajo dio vida al diario de Annie, un objeto esencial que conecta emocionalmente a los personajes y funciona como hilo conductor simbólico de la historia.\n\nDesde el arte, Nacho ayudó a construir dos mundos diferenciados: el de Jessica y el de Annie, cada uno con su propio lenguaje visual. El tren se transformó en el espacio interior de Jessica, un mundo que evoluciona y se va transformando junto a su proceso emocional.\n\nEl uso de la paleta de colores permitió guiar al espectador a través de distintos tiempos y estados de ánimo, marcando transiciones emocionales de forma sutil pero poderosa. Cada elemento de utilería y diseño aportó coherencia, profundidad y atmósfera al universo de La Última Estación.`, img: "/Nacho.jpg" },
